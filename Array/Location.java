...
public class Location implements Cloneable
{
   ...
   **/
   ...
   // ************* For Lab 3 (cis 351, fall 2019)  ********************
   // the code below shows you can write distanceFrom using the original
   // distance function. In your work (i.e. the code at the bottom of the
   // file), DO NOT USE the given distance function.
   // comment out the following code after you have completed the one at 
   // the bottom of this file
   
      public double distanceFrom(Location pt) {
        return Location.distance(this, pt);
      }
...
// uncomment and complete the function distanceFrom below
// this function will compute the distance from pt to `this' location
/*   
   public double distanceFrom(Location pt) {
